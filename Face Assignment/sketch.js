...
function drawEars(){
  ...
  //do not edit width/2 or height/2
  //it is fine without rotate if you can not rotate
  // i got this dawg
  arc(width/2-faceWidth/6,height/2-faceWidth/5,faceWidth/1.6,faceHeight/2.8,PI/2,3*PI,OPEN);
  noFill();
  arc(width/2-faceWidth/6,height/2-faceWidth/5,faceWidth/2,faceHeight/3,PI/2,3*PI,OPEN);
  rotate(24.5);
  rotate(-74);
  //Right ear
  fill(248, 204, 169);
  arc(width/2+faceWidth/25,height/2-faceWidth/50,faceWidth/3,faceHeight/2.50,PI/2.5,3*PI,OPEN);
  noFill();
  arc(width/2+faceWidth/25,height/2-faceWidth/50,faceWidth/3,faceHeight/3,PI/2,3*PI,OPEN);
  rotate(74);
  }
